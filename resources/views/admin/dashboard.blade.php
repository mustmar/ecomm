...
<html lang="en">
  <head>
    ...
    <!-- End layout styles -->
    <link rel="shortcut icon" href="Frontend/admin/css/Frontend/admin/css/images/favicon.png" />
  </head>
  <body>
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="navbar-brand-wrapper d-flex align-items-center">
          <a class="navbar-brand brand-logo" href="index.html">
            <img src="Frontend/admin/css/images/logo.svg" alt="logo" class="logo-dark" />
          </a>
          <a class="navbar-brand brand-logo-mini" href="index.html"><img src="Frontend/admin/css/images/logo-mini.svg" alt="logo" /></a>
        </div>
          ...
          <ul class="navbar-nav navbar-nav-right ml-auto">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list pb-0" aria-labelledby="messageDropdown">
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                    <img src="Frontend/admin/css/images/faces/face10.jpg" alt="image" class="img-sm profile-pic">
                  </div>
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                    <img src="Frontend/admin/css/images/faces/face12.jpg" alt="image" class="img-sm profile-pic">
                  </div>
                  <div class="preview-item-content flex-grow py-2">
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                    <img src="Frontend/admin/css/images/faces/face1.jpg" alt="image" class="img-sm profile-pic">
                  </div>
                  <div class="preview-item-content flex-grow py-2">
            ...
            <li class="nav-item dropdown d-none d-xl-inline-flex user-dropdown">
              <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                <img class="img-xs rounded-circle ml-2" src="Frontend/admin/css/images/faces/face8.jpg" alt="Profile image"> <span class="font-weight-normal"> Henry Klein </span></a>
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                <div class="dropdown-header text-center">
                  <img class="img-md rounded-circle" src="Frontend/admin/css/images/faces/face8.jpg" alt="Profile image">
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="Frontend/admin/css/pages/ui-features/buttons.html">Buttons</a></li>
                  <li class="nav-item"> <a class="nav-link" href="Frontend/admin/css/pages/ui-features/typography.html">Typography</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="Frontend/admin/css/pages/icons/simple-line-icons.html">
                <span class="menu-title">Icons</span>
                <i class="icon-globe menu-icon"></i>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="Frontend/admin/css/pages/forms/basic_elements.html">
                <span class="menu-title">Form Elements</span>
                <i class="icon-book-open menu-icon"></i>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="Frontend/admin/css/pages/charts/chartist.html">
                <span class="menu-title">Charts</span>
                <i class="icon-chart menu-icon"></i>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="Frontend/admin/css/pages/tables/basic-table.html">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="auth">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="Frontend/admin/css/pages/samples/login.html"> Login </a></li>
                  <li class="nav-item"> <a class="nav-link" href="Frontend/admin/css/pages/samples/register.html"> Register </a></li>
                  <li class="nav-item"> <a class="nav-link" href="Frontend/admin/css/pages/samples/error-404.html"> 404 </a></li>
                  <li class="nav-item"> <a class="nav-link" href="Frontend/admin/css/pages/samples/error-500.html"> 500 </a></li>
                  <li class="nav-item"> <a class="nav-link" href="Frontend/admin/css/pages/samples/blank-page.html"> Blank Page </a></li>
                </ul>
              </div>
            </li>
                    ...
                    <div class="table-responsive border rounded p-1">
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <img class="img-sm rounded-circle" src="Frontend/admin/css/images/faces/face1.jpg" alt="profile image"> Katie Holmes
                            </td>
                            <td>$3621</td>
                            <td><img src="Frontend/admin/css/images/dashboard/alipay.png" alt="alipay" class="gateway-icon mr-2"> alipay</td>
                            <td>04 Jun 2019</td>
                            <td>18 Jul 2019</td>
                            <td>
                          ...
                          <tr>
                            <td>
                              <img class="img-sm rounded-circle" src="Frontend/admin/css/images/faces/face2.jpg" alt="profile image"> Minnie Copeland
                            </td>
                            <td>$6245</td>
                            <td><img src="Frontend/admin/css/images/dashboard/paypal.png" alt="alipay" class="gateway-icon mr-2"> Paypal</td>
                            <td>25 Sep 2019</td>
                            <td>07 Oct 2019</td>
                            <td>
                          ...
                          <tr>
                            <td>
                              <img class="img-sm rounded-circle" src="Frontend/admin/css/images/faces/face3.jpg" alt="profile image"> Rodney Sims
                            </td>
                            <td>$9265</td>
                            <td><img src="Frontend/admin/css/images/dashboard/alipay.png" alt="alipay" class="gateway-icon mr-2"> alipay</td>
                            <td>12 dec 2019</td>
                          ...
                          <tr>
                            <td>
                              <img class="img-sm rounded-circle" src="Frontend/admin/css/images/faces/face4.jpg" alt="profile image"> Carolyn Barker
                            </td>
                            <td>$2263</td>
                            <td><img src="Frontend/admin/css/images/dashboard/alipay.png" alt="alipay" class="gateway-icon mr-2"> alipay</td>
                            <td>30 Sep 2019</td>
    ...
    <!-- container-scroller -->
    <!-- plugins:js -->
    <script src="Frontend/admin/css/js/vendor.bundle.base.js"></script>
    <!-- endinject -->
    <!-- Plugin js for this page -->
    <script src="Frontend/admin/css/chart.js/Chart.min.js"></script>
    <script src="Frontend/admin/css/moment/moment.min.js"></script>
    <script src="Frontend/admin/css/daterangepicker/daterangepicker.js"></script>
    <script src="Frontend/admin/css/chartist/chartist.min.js"></script>
    <!-- End plugin js for this page -->
    <!-- inject:js -->
    <script src="Frontend/admin/css/js/off-canvas.js"></script>
    <script src="Frontend/admin/cssjs/misc.js"></script>
    <!-- endinject -->
    <!-- Custom js for this page -->
    <script src="Frontend/admin/css/js/dashboard.js"></script>
